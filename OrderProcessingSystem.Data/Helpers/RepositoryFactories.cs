...
{
    /// <summary>
    /// A maker of MagixList Repositories.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Return the runtime MagixList repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        private IDictionary<Type, Func<DbContext, object>> GetMagixListFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                    //{typeof(IMagixUserRepository), dbContext => new MagixUserRepository(dbContext)},
                    //{typeof(IListRepository), dbContext => new ListRepository(dbContext)},
                };
        }

        /// <summary>
        /// Constructor that initializes with runtime MagixList repository factories
        /// </summary>
        public RepositoryFactories()
        {
            _repositoryFactories = GetMagixListFactories();
        }
